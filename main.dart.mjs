...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1298: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1300: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1301: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1307: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1308: x0 => x0.decode(),
      _1309: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1310: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      ...
      _1313: x0 => x0.send(),
      _1314: () => new XMLHttpRequest(),
      _1315: x0 => ({type: x0}),
      _1316: (x0,x1) => new Blob(x0,x1),
      _1321: (x0,x1) => x0.item(x1),
      _1322: () => new FileReader(),
      _1324: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1325: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1325(f,arguments.length,x0) }),
      ...
      _1329: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1329(f,arguments.length,x0) }),
      _1330: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1330(f,arguments.length,x0) }),
      _1331: (x0,x1) => x0.removeChild(x1),
      _1337: Date.now,
      ...
      _1521: o => o.length,
      _1523: (o, i) => o[i],
      _1524: f => f.dartFunction,
      _1525: () => ({}),
      _1526: () => [],
      _1528: () => globalThis,
      _1529: (constructor, args) => {
      ...
      _1531: (o, p) => o[p],
      _1532: (o, p, v) => o[p] = v,
      _1533: (o, m, a) => o[m].apply(o, a),
      _1535: o => String(o),
      _1536: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1537: o => {
      ...
      _1564: (o, p) => o[p],
      _1567: x0 => x0.random(),
      _1570: () => globalThis.Math,
      _1571: Function.prototype.call.bind(Number.prototype.toString),
      _1572: Function.prototype.call.bind(BigInt.prototype.toString),
      _1573: Function.prototype.call.bind(Number.prototype.toString),
      _1574: (d, digits) => d.toFixed(digits),
      _1588: () => globalThis.document,
      _1594: (x0,x1) => { x0.height = x1 },
      _1596: (x0,x1) => { x0.width = x1 },
      _1605: x0 => x0.style,
      _1608: x0 => x0.src,
      _1609: (x0,x1) => { x0.src = x1 },
      _1610: x0 => x0.naturalWidth,
      _1611: x0 => x0.naturalHeight,
      _1627: x0 => x0.status,
      _1628: (x0,x1) => { x0.responseType = x1 },
      _1630: x0 => x0.response,
      _1739: (x0,x1) => { x0.draggable = x1 },
      _1755: x0 => x0.style,
      _2114: (x0,x1) => { x0.download = x1 },
      _2139: (x0,x1) => { x0.href = x1 },
      _2684: (x0,x1) => { x0.accept = x1 },
      _2698: x0 => x0.files,
      _2724: (x0,x1) => { x0.multiple = x1 },
      _2742: (x0,x1) => { x0.type = x1 },
      _3460: () => globalThis.window,
      _3522: x0 => x0.navigator,
      _3911: x0 => x0.userAgent,
      _6125: x0 => x0.firstChild,
      _6136: () => globalThis.document,
      _6218: x0 => x0.body,
      _6549: (x0,x1) => { x0.id = x1 },
      _6576: x0 => x0.children,
      _8077: x0 => x0.size,
      _8078: x0 => x0.type,
      _8085: x0 => x0.name,
      _8091: x0 => x0.length,
      _8096: x0 => x0.result,
      _11005: (x0,x1) => { x0.display = x1 },
