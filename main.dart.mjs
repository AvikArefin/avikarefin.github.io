...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1622: () => globalThis.window.navigator.userAgent,
      ...
      _1641: (x0,x1) => x0.querySelector(x1),
      _1642: (x0,x1) => x0.querySelector(x1),
      _1643: x0 => ({type: x0}),
      _1644: (x0,x1) => new Blob(x0,x1),
      _1645: x0 => globalThis.URL.createObjectURL(x0),
      _1646: (x0,x1) => x0.item(x1),
      _1649: () => new FileReader(),
      _1650: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1651: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1651(f,arguments.length,x0) }),
      _1652: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      _1653: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1653(f,arguments.length,x0) }),
      _1654: (x0,x1,x2) => x0.addEventListener(x1,x2),
      ...
      _1657: (x0,x1) => x0.removeChild(x1),
      _1658: x0 => x0.click(),
      _1659: (x0,x1) => x0.removeChild(x1),
      ...
      _1769: s => JSON.stringify(s),
      _1770: s => printToConsole(s),
      _1771: a => a.join(''),
      _1772: (o, a, b) => o.replace(a, b),
      _1774: (s, t) => s.split(t),
      _1775: s => s.toLowerCase(),
      _1776: s => s.toUpperCase(),
      _1777: s => s.trim(),
      _1778: s => s.trimLeft(),
      _1779: s => s.trimRight(),
      _1781: (s, p, i) => s.indexOf(p, i),
      _1782: (s, p, i) => s.lastIndexOf(p, i),
      _1783: (s) => s.replace(/\$/g, "$$$$"),
      _1784: Object.is,
      _1785: s => s.toUpperCase(),
      _1786: s => s.toLowerCase(),
      _1787: (a, i) => a.push(i),
      _1788: (a, i) => a.splice(i, 1)[0],
      _1790: (a, l) => a.length = l,
      _1791: a => a.pop(),
      _1792: (a, i) => a.splice(i, 1),
      _1794: (a, s) => a.join(s),
      _1795: (a, s, e) => a.slice(s, e),
      _1796: (a, s, e) => a.splice(s, e),
      _1798: a => a.length,
      _1800: (a, i) => a[i],
      _1801: (a, i, v) => a[i] = v,
      ...
      _1805: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1806: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1807: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1808: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1809: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      ...
      _1813: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1814: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1815: (t, s) => t.set(s),
      _1817: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1819: o => o.buffer,
      _1820: o => o.byteOffset,
      _1821: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1822: (b, o) => new DataView(b, o),
      _1823: (b, o, l) => new DataView(b, o, l),
      _1824: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1825: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1826: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1827: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1828: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1829: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1830: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1831: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1832: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1833: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1834: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1835: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1838: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1839: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1840: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1841: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1842: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1843: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1856: (o, t) => o instanceof t,
      ...
      _1860: o => Object.keys(o),
      _1861: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1862: (handle) => clearTimeout(handle),
      _1863: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1864: (handle) => clearInterval(handle),
      _1865: (c) =>
      ...
      _1977: (o, p) => o[p],
      _1978: (o, p, v) => o[p] = v,
      _1979: (o, m, a) => o[m].apply(o, a),
      _1981: o => String(o),
      _1982: (p, s, f) => p.then(s, f),
      _1983: o => {
      ...
      _1997: x0 => x0.index,
      _1998: x0 => x0.groups,
      _2000: (x0,x1) => x0.exec(x1),
      _2002: x0 => x0.flags,
      _2003: x0 => x0.multiline,
      _2004: x0 => x0.ignoreCase,
      _2005: x0 => x0.unicode,
      _2006: x0 => x0.dotAll,
      _2007: (x0,x1) => x0.lastIndex = x1,
      _2009: (o, p) => o[p],
      _2012: x0 => x0.random(),
      _2013: x0 => x0.random(),
      _2017: () => globalThis.Math,
      _2019: Function.prototype.call.bind(Number.prototype.toString),
      _2020: (d, digits) => d.toFixed(digits),
      _2024: () => globalThis.document,
      _2048: x0 => x0.src,
      _2049: (x0,x1) => x0.src = x1,
      _2050: x0 => x0.naturalWidth,
      _2051: x0 => x0.naturalHeight,
      _2076: x0 => x0.status,
      _2077: (x0,x1) => x0.responseType = x1,
      _2079: x0 => x0.response,
      _2083: () => globalThis.window.flutterCanvasKit,
      _2084: () => globalThis.window._flutter_skwasmInstance,
      _2207: (x0,x1) => x0.draggable = x1,
      _2223: x0 => x0.style,
      ...
      _4019: x0 => x0.navigator,
      _4410: x0 => x0.userAgent,
      _6725: x0 => x0.firstChild,
      _6736: () => globalThis.document,
      _7180: (x0,x1) => x0.id = x1,
      _7207: x0 => x0.children,
      _8749: x0 => x0.size,
      _8750: x0 => x0.type,
      _8757: x0 => x0.name,
      _8764: x0 => x0.length,
      _8775: x0 => x0.result,
      _11724: (x0,x1) => x0.display = x1,
